...
public class MoviesWithRetroFit {
    ...
    @Expose
    private ArrayList<MoviesWithRetroFitMovie> results = null;
    ...
    public ArrayList<MoviesWithRetroFitMovie> getResults() {
        return results;
    }

    public void setResults(ArrayList<MoviesWithRetroFitMovie> results) {
